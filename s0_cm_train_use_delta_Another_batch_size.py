...
for mini_batch_size in mini_batch_size_list:
    for penalty_const in penalty_const_list:
        ...
        # 2. restore
        restore = True
        _,_,cm_resnet_grid_output_dic = util.est_cm_resnet_use_delta(data_grid, cm_param_dic, penalty_const, MODEL_NAME, restore, n_epoches = n_epoches, K = K, n_mini_batch = mini_batch_size)
    ...
    #
#
    with open('cm_info_use_delta_batch_size_' + str(mini_batch_size) + '.pickle', 'wb') as f:
