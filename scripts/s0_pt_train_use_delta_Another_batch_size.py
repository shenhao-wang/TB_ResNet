...
def model(PT, DNN, RESNET, Load_old_results):
    ...
    if Load_old_results:
        ...
        pt_info = {}
    mini_batch_size_list = [128]  #mini_batch_size_list = [64,128]
            ...
            #    penalty_const = 0.01
                ...
                for replica in range(num_replications):
                    _pt_resnet_params_dic, _pt_resnet_hyper_params_dic, _pt_resnet_output_dic = util.est_pt_resnet_use_delta(data, pt_param_dic,
                                                                                                                ...
                                                                                                                MODEL_NAME, restore,
                                                                                                                n_epoches,
                                                                                                                current_best_acc=current_best_acc, n_mini_batch = mini_batch_size)
    ...
    #
            with open('pt_info_use_delta_batch_size_' + str(mini_batch_size) + '.pickle', 'wb') as f:
