...
elast_records_cm_save.to_csv('output/table/elasticity_cm_use_delta.csv', index=False)
#
...
MODEL_NAME = 'cm_dnn'
l2_reg = 1e-50
elast_records = util.est_dnn_elasticity(data, MODEL_NAME, all_elas_var,all_elas_var_id, df_sp_test_nonstand,l2_reg, n_epoches = n_epoches, K = len(modes_list))
...
elast_records_cm_dnn_save.to_csv('output/table/elasticity_cm_dnn_use_delta.csv', index=False)
#
...
for penalty_const in penalty_const_list:
    ...
    elast_records = util.est_cm_resnet_elasticity_use_delta(data, cm_param_dic, penalty_const, MODEL_NAME, all_elas_var, df_sp_test_nonstand,
    ...
    elast_records_cm_resnet_save.to_csv('output/table/elasticity_cm_resnet_' + str(penalty_const) + '_use_delta.csv', index=False)
