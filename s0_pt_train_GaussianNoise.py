...
# meta
pt_info = {}
penalty_const_list = [1e-50, 0.0001, 0.01]
...
for epsilon in epsilon_list:
    ...
    pt_est_adv_GN_output_dic[epsilon] = {'accuracy_training':pt_est_adv_GN_output['accuracy_training'], 'accuracy_testing':pt_est_adv_GN_output['accuracy_testing']}
...
#    penalty_const = 0.01
    ...
    for epsilon in epsilon_list:
        ...
        restore = True
        data_adv_GN =  util_helpers.GN_adv_examples(data, data_len_list, epsilon)
        _,_,pt_dnn_adv_GN_output=util.est_dnn(data_adv_GN, penalty_const, MODEL_NAME, restore, n_epoches, K = K)
        pt_dnn_adv_GN_output_dic[epsilon] = {'accuracy_training':pt_dnn_adv_GN_output['accuracy_training'], 'accuracy_testing':pt_dnn_adv_GN_output['accuracy_testing']}
...
#    penalty_const = 0.01
    ...
    for epsilon in epsilon_list:
        ...
        restore = True
        data_adv_GN =  util_helpers.GN_adv_examples(data, data_len_list, epsilon)
        _,_,pt_resnet_adv_GN_output=util.est_pt_resnet(data_adv_GN, pt_param_dic, penalty_const, MODEL_NAME, restore, n_epoches = n_epoches, K = K)
        pt_resnet_adv_GN_output_dic[epsilon] = {'accuracy_training':pt_resnet_adv_GN_output['accuracy_training'], 'accuracy_testing':pt_resnet_adv_GN_output['accuracy_testing']}
...
#
with open('pt_info_GN.pickle', 'wb') as f:
