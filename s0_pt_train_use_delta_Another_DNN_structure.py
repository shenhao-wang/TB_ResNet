...
pt_info[MODEL_NAME]['fgsm_output']={}
pt_info[MODEL_NAME]['tgsm_output']={}
pt_info[MODEL_NAME]['GN_output']={}
...
# 2. return grid info
restore = True
_,_,pt_dnn_grid_output_dic = util.est_dnn(data_grid_dnn, l2_reg, MODEL_NAME, restore, n_epoches, M = Num_of_layers)
#
...
#    penalty_const = 0.01
    ...
    # 2. restore
    restore = True
    _,_,pt_resnet_grid_output_dic = util.est_pt_resnet_use_delta(data_grid, pt_param_dic, penalty_const,
                                                                 MODEL_NAME, restore, n_epoches,M=Num_of_layers)
...
#
with open('pt_info_use_delta_num_layer_5.pickle', 'wb') as f:
